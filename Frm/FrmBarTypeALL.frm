...
Begin VB.Form FrmBarTypeALL 
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   375
      Left            =   840
      Picture         =   "FrmBarTypeALL.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   5280
      Width           =   1335
   ...
   Begin VB.CommandButton cmd_quit 
      ...
      Height          =   375
      Left            =   2820
      Picture         =   "FrmBarTypeALL.frx":15A2
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5280
      Width           =   1335
   ...
   Begin ComctlLib.ImageList imlIcons 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":2B44
            Key             =   "book"
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList imlSmallIcons 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   5
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":2E5E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":2F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":3052
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":314C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "FrmBarTypeALL.frx":3246
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmBarTypeALL"
...
With st_903_1
    ...
    .Open "select * from mmst903 where len(Bar_No) = 4 order by Bar_No"
End With
